...
_csv_fieldnames_out = _csv_fieldnames + ('5yos', '10yos', '5ym', '10ym',
                                         'points_survival', 'points_metastasis', 'input_complete')
...
def hello_world():
    ...
    if request.method == 'POST':
        ...
        for i in items:
            i['5yos'], i['10yos'], i['5ym'], i['10ym'], i['points_survival'], i['points_metastasis'], i['input_complete'] = calc(i['age'], i['size'], i['grading'], i['histo'])
